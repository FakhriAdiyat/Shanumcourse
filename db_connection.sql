...
(5, 'dimmas', '938727366263864', 'dim', 'dimas@gmail.com', '$2y$10$xBiBJCLOy6K2GXdoXfDchOv6g0ZoOA.U7h3n/efb0X8bYSiLLuQgG', '2024-12-28 03:53:25', 'user', 1, '2024-12-29'),
...
--
-- Table structure for table `user_berlangganan`
--

CREATE TABLE `user_berlangganan` (
  `id_berlangganan` int NOT NULL,
  `user_id` int NOT NULL,
  `tanggal_mulai` datetime NOT NULL,
  `tanggal_berakhir` datetime NOT NULL,
  `status_berlangganan` enum('Aktif','Tidak Aktif') COLLATE utf8mb4_general_ci DEFAULT 'Aktif'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `user_berlangganan`
--
ALTER TABLE `user_berlangganan`
...
--
-- AUTO_INCREMENT for table `user_berlangganan`
--
ALTER TABLE `user_berlangganan`
  MODIFY `id_berlangganan` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `user_berlangganan`
--
ALTER TABLE `user_berlangganan`
  ADD CONSTRAINT `user_berlangganan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
