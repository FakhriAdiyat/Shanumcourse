...
<body>
    ...
    <main>
        <section class="main-services">
            <h1>Deskripsi Layanan Utama</h1>
            <p>Kami menawarkan kursus bahasa Inggris online yang dirancang khusus untuk anak SD. Program kami membantu anak-anak mempelajari dasar-dasar bahasa Inggris melalui metode belajar yang interaktif dan menyenangkan. Dengan pengajar berpengalaman, kami memastikan anak-anak mendapatkan pengalaman belajar terbaik.</p>
            <ul>
                <li>Kursus berjenjang dengan materi dasar hingga lanjutan.</li>
                <li>Video pembelajaran interaktif dan latihan langsung.</li>
                <li>Sertifikat resmi setelah menyelesaikan kursus.</li>
                <li>Akses materi 24/7 dari perangkat mana saja.</li>
            </ul>
        </section>
        ...
        <section class="reviews-section">
            <h2>Ulasan</h2>
            <div class="review">
                <img src="img/rv1.jpg" alt="Reviewer 1">
                <div class="rating">
            ★★★★☆
        </div>
            ...
            <div class="review">
                <img src="img/rv2.jpg" alt="Reviewer 2">
                <div class="rating">
            ★★★★★
        </div>
            ...
            <div class="review">
                <img src="img/rv3.jpg" alt="Reviewer 3">
                <div class="rating">
            ★★★★☆
        </div>
        ...
        <section class="support">
            ...
            <p>Jika Anda memiliki pertanyaan atau membutuhkan bantuan, tim kami siap membantu Anda melalui:</p>
            <ul>
                <li>Email: support@shanumcourse.com</li>
                <li>WhatsApp: +62 899-XXX-XXXX</li>
            </ul>
        </section>
    </main>
    ...
    <footer class="main-footer">
            ...
            <img src="img/footer.gif" alt="Footer GIF">
    </footer>
</body>
</html>
